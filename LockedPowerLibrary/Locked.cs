...
namespace LockedPowerLibrary
{
    ...
    public class Locked
    {
        ...
        private static Application WorkbookWorker(string path, string nameOfList)
        {
        ...
        {
            Application excelFile = WorkbookWorker(filePath, "8 КС (2)");
        ...
        {
            Application excelFile = WorkbookWorker(filePath, "Баланс мощности");
